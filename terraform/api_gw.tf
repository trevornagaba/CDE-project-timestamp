...
resource "aws_apigatewayv2_api" "cde-timestamp-microservice" {
...
resource "aws_apigatewayv2_stage" "v1" {
  api_id = aws_apigatewayv2_api.cde-timestamp-microservice.id
...
resource "aws_cloudwatch_log_group" "api_gw" {
  name = "/aws/api_gw/${aws_apigatewayv2_api.cde-timestamp-microservice.name}"
...
resource "aws_lambda_permission" "api_gw" {
  ...
  source_arn = "${aws_apigatewayv2_api.cde-timestamp-microservice.execution_arn}/*/*"
}